                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-start mb-2">
                                @can('pengajuan_cuti_tenaga_pendidik.create')
                                    ...
                                    <tbody>
                                        @forelse ($dataSelesai as $index => $cutiSelesai)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge text-wrap {{ in_array($cutiSelesai->status_pengajuan, ['disetujui kepala sekolah', 'disetujui dirpen']) ? 'text-bg-success' : 'text-bg-danger' }}">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('pengajuan.cuti.tendik.store') }}" method="post" enctype="multipart/form-data">
                        @csrf @method('post')
