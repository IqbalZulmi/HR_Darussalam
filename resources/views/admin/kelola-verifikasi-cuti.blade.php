...
@section('content')
                            ...
                            <table class="table table-striped table-hover border table-bordered align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-primary"  data-bs-toggle="modal" data-bs-target="#konfirmasiModal">
    ...
    {{-- konfirmasiModal --}}
    <div class="modal fade" id="konfirmasiModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="container-fluid">
                            <div class="row gy-2">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="komentar" class="form-control @error('komentar') is-invalid @enderror" placeholder="Isi dengan komentar"></textarea>
                                    @error('komentar')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
