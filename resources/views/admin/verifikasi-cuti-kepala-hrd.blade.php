                                    ...
                                    <tbody>
                                        @forelse ($dataSelesai as $index => $verifikasiSelesai)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge text-wrap @if ($verifikasiSelesai->status_pengajuan =='disetujui kepala hrd') text-bg-success @elseif ($verifikasiSelesai->status_pengajuan =='ditolak kepala hrd') text-bg-danger @else text-bg-warning @endif">{{ $verifikasiSelesai->status_pengajuan }}</span>
                                                </td>
                                                <td>
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('verifikasi.cuti.kepala.hrd.update',['id_pengajuan' => $verifikasiProses->id]) }}" method="post">
                            @csrf @method('put')
                                ...
                                <div class="row gy-2">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="status_pengajuan" class="form-select @error('status_pengajuan') is-invalid @enderror">
                                            <option value="disetujui kepala hrd menunggu tinjauan dirpen">Setuju</option>
                                            <option value="ditolak kepala hrd">Tolak</option>
                                        </select>
