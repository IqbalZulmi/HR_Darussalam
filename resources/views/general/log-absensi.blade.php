                ...
                <div class="col-12" id="kelola-admin">
                    <div class="card recent-sales overflow-auto">
                        @forelse ($dataAbsensi->logAktivitasAbsensi as $logAbsen )
                            <div class="p-2 text-capitalize  @if ($logAbsen->aksi == 'created' ) bg-success-subtle text-success-emphasis @elseif ($logAbsen->aksi == 'updated') bg-warning-subtle text-warning-emphasis @elseif ($logAbsen->aksi == 'deleted') bg-danger-subtle text-danger-emphasis @else bg-secondary-subtle text-secondary-emphasis @endif">
                                [ {{ $logAbsen->created_at }} ] <span class="fw-semibold">{{ $logAbsen->aksi }}</span> Oleh <span class="fw-semibold">{{ $logAbsen->user->profilePribadi->nama_lengkap ??  'User tidak ditemukan' }}</span>
                                @if (!empty($logAbsen->data_lama || $logAbsen->data_baru))
                                    <div class="accordion mt-2" id="accordionExample">
                                        @if (!empty($logAbsen->data_lama))
                                            <div class="accordion-item @if ($logAbsen->aksi == 'created' ) border-success-subtle @elseif ($logAbsen->aksi == 'updated') border-warning-subtle @elseif ($logAbsen->aksi == 'deleted') border-danger-subtle @else border-secondary-subtle @endif">
                                                ...
                                                <div id="collapseTwo{{ $logAbsen->id }}" class="accordion-collapse collapse">
                                                    <div class="accordion-body">
                                                        @php
                                                            ...
                                                            $dateKeys = ['tanggal', 'check_in', 'check_out', 'created_at', 'updated_at'];
